package com.csx.mobilesafe.service;
...
import com.csx.mobilesafe.activity.EnterPwdActivity;
import com.csx.mobilesafe.db.dao.AppLockDao;
...
public class WatchDogService extends Service {
	...
	public void onCreate() {
		...
		filter.addAction("com.csx.mobilesafe.SKIP_CHECK");
		registerReceiver(mReceiver, filter);

		// 监听程序锁数据库变化
		mObserver = new MyContentObserver(null);
		getContentResolver().registerContentObserver(
				Uri.parse("content://com.csx.mobilesafe/change"), true,
				mObserver);
	}
