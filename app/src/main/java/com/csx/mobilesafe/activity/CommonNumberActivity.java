...
import com.csx.mobilesafe.db.dao.CommonNumberDao;
import com.csx.mobilesafe.db.dao.CommonNumberDao.ChildInfo;
...
public class CommonNumberActivity extends Activity {
	...
	private ArrayList<CommonNumberDao.GroupInfo> mCommonNumerGroups;
		...
		elvList.setOnChildClickListener(new OnChildClickListener() {
			...
			public boolean onChildClick(ExpandableListView parent, View v,
				...
				System.out.println("第" + groupPosition + "组-第" + childPosition
						+ "项被点击");
				CommonNumberDao.ChildInfo child = mAdapter.getChild(groupPosition,
						childPosition);
