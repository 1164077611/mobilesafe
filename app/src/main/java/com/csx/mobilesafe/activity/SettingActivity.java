...
import com.csx.mobilesafe.service.AddressService;
import com.csx.mobilesafe.service.BlackNumberService;
import com.csx.mobilesafe.service.WatchDogService;
import com.csx.mobilesafe.utils.PrefUtils;
import com.csx.mobilesafe.utils.ServiceStatusUtils;
import com.csx.mobilesafe.view.SettingItemClickView;
...
public class SettingActivity extends Activity {
	...
	private void initAppLock() {
		...
		boolean serviceRunning = ServiceStatusUtils.isServiceRunning(
				"com.csx.mobilesafe.service.WatchDogService", this);
	...
	private void initBlackNumber() {
		...
		// 判断服务是否运行, 运行时才勾选,否则不勾选
		boolean serviceRunning = ServiceStatusUtils.isServiceRunning(
				"com.csx.mobilesafe.service.BlackNumberService", this);
	...
	private void initAddress() {
		...
		// 判断服务是否运行, 运行时才勾选,否则不勾选
		boolean serviceRunning = ServiceStatusUtils.isServiceRunning(
				"com.csx.mobilesafe.service.AddressService", this);
