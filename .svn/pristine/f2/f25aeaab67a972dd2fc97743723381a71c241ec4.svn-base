package com.csx.mobilesafe.view;
...
public class SettingItemView extends RelativeLayout {
	...
	public SettingItemView(Context context, AttributeSet attrs) {
		...
		String title = attrs.getAttributeValue(NAMESPACE, "m_title");
		System.out.println("自定义属性:"+title);
		mDescOn = attrs.getAttributeValue(NAMESPACE, "m_desc_on");
		mDescOff = attrs.getAttributeValue(NAMESPACE, "m_desc_off");
